...
#BSUB -o o.prsetexpr_WMH_Vol
#BSUB -e e.prsetexpr_WMH_Vol
...
Rscript /sc/arion/projects/psychgen/cotea02_prset/PRSice.R --prsice /sc/arion/projects/psychgen/cotea02_prset/PRSice_linux \
    ...
    --num-auto 22 \
    --out /sc/arion/projects/paul_oreilly/lab/cotea02/pathway_prs_ad/results/prset_nothreshold_eur_WMH_Vol \
    --pheno /sc/arion/projects/paul_oreilly/lab/cotea02/pathway_prs_ad/data/phenotypes/mri_phenotypes_resid_RINT.txt \
    --pheno-col WMH_Vol \
    --set-perm 10000 \
