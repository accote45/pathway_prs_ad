...
#BSUB -o o.prsetexpr_NEFL
#BSUB -e e.prsetexpr_NEFL
...
Rscript /sc/arion/projects/psychgen/cotea02_prset/PRSice.R --prsice /sc/arion/projects/psychgen/cotea02_prset/PRSice_linux \
    ...
    --num-auto 22 \
    --out /sc/arion/projects/paul_oreilly/lab/cotea02/pathway_prs_ad/results/prset_nothreshold_eur_NEFL \
