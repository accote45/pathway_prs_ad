...
combined_lines <- readLines("/sc/arion/projects/paul_oreilly/lab/cotea02/pathway_prs_ad/data/pruned_pathway_output/pathways_retained.gmt")
...
out_path <- "/sc/arion/projects/paul_oreilly/lab/cotea02/pathway_prs_ad/data/master.gmt"
...
out_path_no_apoe <- "/sc/arion/projects/paul_oreilly/lab/cotea02/pathway_prs_ad/data/master_no_apoe.gmt"
...
background_path <- "/sc/arion/projects/paul_oreilly/lab/cotea02/pathway_prs_ad/data/background_genes.txt"
