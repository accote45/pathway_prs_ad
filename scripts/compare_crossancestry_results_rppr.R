...
# --- Load summary files ---
master <- fread("ad_case.control_prset_nothreshold5.summary", sep = "\t")
eur    <- fread("ad_case.control_prset_nothreshold_eur.summary", sep = "\t")
afr    <- fread("ad_case.control_prset_nothreshold_afr.summary", sep = "\t")
...
# --- Save ---
fwrite(all_pos, "crossancestry_pathway_comparison.tsv", sep = "\t")
